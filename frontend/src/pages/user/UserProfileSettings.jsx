  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div className="border-b border-outline-variant pb-6">
        ...
        <p className="font-body-md text-secondary mt-1">Manage your personal information and security</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="col-span-1">
          <Card className="flex flex-col items-center text-center p-6">
            <div className="w-24 h-24 rounded-full bg-primary-fixed text-primary font-bold text-3xl flex items-center justify-center mb-4 shadow-sm">
              {initials}
            </div>
